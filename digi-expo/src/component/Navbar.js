        ...
        switch (currentUser.role) {
                ...
                return (
                    <>
                        <li className="nav-item">
                            <Link className="nav-link text-purple" to="/associations">Associations</Link>
                        </li>
                        <li className="nav-item">
            ...
            case 'BENEVOLE':
                return (
                    <>
                        <li className="nav-item">
                                <Link className="nav-link text-purple"
                                      to="/volunteer/all-associations">Associations</Link>
                            </li>
                            <li className="nav-item">
                        ...
                        return (
                            <>
                                <li className="nav-item">
                                    <Link className="nav-link text-purple"
                                          to="/associations">Associations</Link>
                                </li>
                                <li className="nav-item">
                                    <Link
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link text-purple"
                                          to="/association/volunteers">Volunteers</Link>
                                </li>
                                <li className="nav-item">
                                    ...
                                    <ul className="navbar-nav ms-auto">
                                        {isAuthenticated ? (
                                            <>
                                                ...
                                                <li className="nav-item">
                                                    <button className="btn btn-outline-purple nav-link"
                                            ...
                                            <>
                                                ...
                                                <li className="nav-item">
                                                    <Link className="nav-link btn-outline-purple" to="/associations">Associations</Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link className="nav-link btn-outline-purple"
                                                          to="/login">Login</Link>
                                                </li>
                                                <li className="nav-item">
